			...
			<table class="table table-hover">
				...
				<div class="col-6 dd">
					<div class="input-group">
						<input type="text" name="search" class="form-control" id="inlineFormInputGroupUsername" placeholder="Input Word">
					</div>
				</div>
			...
			<nav aria-label="Page navigation example" class="col-lg-6 b">
				<ul class="pagination">
					...
					<c:forEach begin="${pager.startNum}" end="${pager.lastNum}" var="i">
						<li class="page-item">
							<a class="page-link" href="./list.naver?page=${i}&kind${pager.kind}&search=${pager.search}">${i} </a>
						</li>
					</c:forEach>
					...
					<c:choose>
						<c:when test="${pager.next}">
							<li class="page-item">
								<a class="page-link" href="./list.naver?page=${pager.lastNum + 1}&kind${pager.kind}&search=${pager.search}" aria-label="Next">
