	...
	<section class="container-fluid col-lg-6">
		...
		<form action="./reply.naver" method="post">
			...
			<table class="table table-hover">
				<div class="mb-3">
					<label>Title</label>
					<input type="text" class="form-control" name="title" aria-describedby="emailHelp" placeholder="Title Input">
					<div class="form-text">Input Title</div>
				</div>
				<div class="mb-3">
					<label>Writer</label>
					<input type="text" class="form-control" name="writer" aria-describedby="emailHelp" placeholder="Writer Input">
					<div class="form-text">Input Writer</div>
				</div>
				<div class="mb-3">
					<label>Contents</label>
					<textarea rows="5" cols="20" class="form-control" name="contents" placeholder="Contents Input"></textarea>
