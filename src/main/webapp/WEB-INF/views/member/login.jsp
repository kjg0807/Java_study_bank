<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		...
		<body>
			...
			<form action="./login.naver" method="post" id="frm">

				<section class="col-lg-6 container-fluid mt-4">
					<div class="row">
						<div class="mb-3">
							<label>ID</label>
							<input type="text" id="id" class="form-control" name="userid" aria-describedby="emailHelp"
						...
						<div class="mb-3">
							...
							<input type="password" id="pwd" class="form-control" name="pwd" placeholder="Password Input"
